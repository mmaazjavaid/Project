...
function AdDetails({ad_details,handleButtonClick}) {
  ...
  return (
    ...
    <div class="ad_details_con">
      <i style={{marginTop:'20px',display:'flex'}} onClick={()=>handleButtonClick(ad_details)} class="bi bi-arrow-left-circle-fill"></i>
      <div class="ad_details_con2">
            ...
            <div id="carouselExample" class="carousel slide">
              <div class="carousel-inner">
                 {ad_details.images.length==0? 
                  ...
                  {/* <div class={`carousel-item active`}>
                    <img src={ad_details.images[0]} class="d-block w-100" alt="..." />
                  </div> */}
                  {/* })}   */}
              </div>
              <button
        ...
        <div class="ad_con2">
          ...
          <div  class="buy_now"><button style={{marginLeft:'25px'}}>Order Now</button></div>
          <div class="posted">
            <span
              style={{
                fontSize: '20px',
            ...
            >
              ...
              <span style={{fontSize: '13px', fontWeight: '700'}}
                >Ad ID {ad_details._id.substring(0,8)}...</span
              >
            </div>
          </div>
        </div>
